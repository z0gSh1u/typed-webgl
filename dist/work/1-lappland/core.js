...
define(["require", "exports", "../../framework/2d/WebGLHelper2d", "../../framework/WebGLUtils", "../../framework/2d/BezierCurve", "../../framework/2d/BasicShape", "../../framework/2d/DrawingObject2d", "../../framework/2d/DrawingPackage2d", "../../3rd-party/MV", "../../3rd-party/initShaders"], function (require, exports, WebGLHelper2d_1, WebGLUtils, BezierCurve_1, BasicShape_1, DrawingObject2d_1, DrawingPackage2d_1) {
    "use strict";
    ...
    var listenMenu = function () {
        document.querySelector("#btnExec").onclick = function () {
            ...
            if (val == "vow") {
                ...
                // 脸
                face = new DrawingPackage2d_1.DrawingPackage2d(new DrawingObject2d_1.DrawingObject2d("主体", [[304, 220], 170 / 2, 168 / 2], BasicShape_1.generateOval, gl.TRIANGLE_FAN, COLORS.WHITE), new DrawingObject2d_1.DrawingObject2d("勾线", [[304, 220], 170 / 2, 168 / 2], BasicShape_1.generateOval, gl.LINE_STRIP, COLORS.BLACK));
                prepareDrawLater();
                helper.reRender();
            }
        };
