...
define(["require", "exports", "../utils/WebGLHelper2d", "../utils/WebGLUtils", "../utils/BezierCurve", "../utils/BasicShape", "../../3rd-party/MV", "../../3rd-party/initShaders"], function (require, exports, WebGLHelper2d_1, WebGLUtils, BezierCurve_1, BasicShape_1) {
    "use strict";
    ...
    var render = function () {
        ...
        // 中央刘海
        var liusea_1 = BezierCurve_1.generateBezierCurve2dL3([271.33, 129], [271.6, 165], [290.6, 204], [333, 202]);
        ...
        var liusea_2 = BezierCurve_1.generateBezierCurve2dL3([365.5, 130], [365.6, 111.6], [368.6, 174.6], [328, 204]);
        ...
        var liusea_3 = [[330.3, 204], [271.33, 129], [365.5, 130]];
        ...
        var eye_left_1 = BezierCurve_1.generateBezierCurve2dL3([233, 236], [248, 209.33], [287, 193], [294.6, 238]);
        ...
        var eye_right_1 = BezierCurve_1.generateBezierCurve2dL3([330, 229], [335.3, 209.6], [355.3, 195], [368, 228]);
        ...
        var eye_right_2 = BezierCurve_1.generateBezierCurve2dL3([331, 229], [318, 229], [350, 250], [368, 226.6]);
        ...
        // 脸
        var face_1 = BasicShape_1.generateOval([304, 220], 170 / 2, 168 / 2);
        ...
        // 头部实体
        var head_1 = BasicShape_1.generateOval([290, 180], 274 / 2, 235 / 2);
